...
class SearchMemoryRequest(BaseModel):
    ...
    agent_id: str = Field(..., description="Agent that owns the memories to search")
...
async def store_memory(request: StoreMemoryRequest, app_request: Request) -> MemoryResponse:
    """
    Store a new memory.
...
async def search_memories(
    request: SearchMemoryRequest, app_request: Request
) -> list[MemoryResponse]:
    """
...
async def list_memories(
    ...
    try:
        ...
        memories = await store.list_memories(filters=filters, limit=limit, offset=offset)
