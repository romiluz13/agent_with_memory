...
class MongoDBClient:
    ...
    def __init__(self):
        ...
        if not hasattr(self, "_initialized"):
            ...
            self.config: MongoDBConfig | None = None
    ...
    async def initialize(self, config: MongoDBConfig):
        ...
        try:
            # Create client with connection pooling and production-grade settings
            # mongodb-connection: "Memory systems require w:'majority' write concern
            # for durability. Add retryWrites=true and retryReads=true."
    ...
    def reset(cls):
        ...
        mongodb-connection: Managed singletons with reset for testing.
        This allows tests to get a fresh MongoDBClient instance.
        """
        if cls._client:
            cls._client.close()
        cls._client = None
...
async def initialize_mongodb(
    uri: str, database: str = "ai_agent_boilerplate", **kwargs
) -> MongoDBClient:
    """
    ...
    """
    config = MongoDBConfig(uri=uri, database=database, **kwargs)
